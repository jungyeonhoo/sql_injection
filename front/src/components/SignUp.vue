<template>
  <v-container style="max-width: 900px">
    <v-card class="ma-10 pa-10 elevation-10" title="SignUp">
      ...
      <v-text-field
        ...
        v-model="ps_input"
      />
      <v-btn color="#2196F3" @click="submit"> SignUp</v-btn>
      <v-btn variant="text" color="teal-accent-4" @click="login">
        Go To Login
      </v-btn>
    </v-card>
  </v-container>
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.id_input == "") {
        ...
        axios
          .post("https://loginbackend-cyltk.run.goorm.site/signin", {
